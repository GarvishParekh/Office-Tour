...
public class VideoURLManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        /*
        Debug.Log("m_VideoPlayer.isPlaying: " + m_VideoPlayer.isPlaying);
        if (_canPlay)
        {
            m_VideoPlayer.Play();
            _canPlay = false;
            Debug.Log("m_VideoPlayer.isPlaying from _canPlay: " + m_VideoPlayer.isPlaying);
        }
        */
        if(_debug)
        {
    ...
    public void OnClick_PlayPause()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                m_VideoPlayer.Play();
                Debug.Log("From OnClick_PlayPause");
    ...
    {
         //= m_VideoPlayer.GetDirectAudioMute(0);
    ...
    private void PrepareComplete(VideoPlayer source)
    {
        ...
        HTMLButtonPlugin();
        //m_VideoPlayer.Play();
        Debug.Log("From PrepareComplete");
